    ...
    return (
        <a href="#" className="flex flex-col min-w-[120px] max-w-[380px] p-2 rounded-md 
            ...
            <div className="flex flex-col pl-2 pt-2 min-h-[100px] max-h-[150px]">
                <h1 className="text-lg font-bold tracking-tight whitespace-nowrap text-gray-900 text-white overflow-hidden text-ellipsis max-w-[95%]">{props.title}</h1>
                <p className="font-normal text-sm text-gray-400 basis-16 overflow-hidden break-all paragraph-wrap-3 max-w-[95%]">{props.description}</p>
